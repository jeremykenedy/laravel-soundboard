## Laravel Soundboard
#### A powerful open source Laravel Soundboard with Admin Panel CRUD (Create Read Update Delete) built on [Laravel](http://laravel.com/) 5.8, [Bootstrap](http://getbootstrap.com) 4, and [Vue.js](https://vuejs.org/)
...
|        | POST      | api/sounds                      | sounds.store                                  | App\Http\Controllers\Api\SoundsController@store                                                                 | api                                            |
|        | GET|HEAD  | api/sounds                      | sounds.index                                  | App\Http\Controllers\Api\SoundsController@index                                                                 | api                                            |
|        | GET|HEAD  | api/sounds/{sound}              | sounds.show                                   | App\Http\Controllers\Api\SoundsController@show                                                                  | api                                            |
|        | PUT|PATCH | api/sounds/{sound}              | sounds.update                                 | App\Http\Controllers\Api\SoundsController@update                                                                | api                                            |
|        | DELETE    | api/sounds/{sound}              | sounds.destroy                                | App\Http\Controllers\Api\SoundsController@destroy                                                               | api                                            |
...
|        | GET|HEAD  | sounds                          | sounds                                        | App\Http\Controllers\SoundsController@index                                                                     | web,activity,auth                              |
