## Laravel Soundboard
#### A powerful open source Laravel Sounboard with Admin Panel CRUD (Create Read Update Delete) built on [Laravel](http://laravel.com/) 5.8, [Bootstrap](http://getbootstrap.com) 4, and [Vue.js](https://vuejs.org/)
